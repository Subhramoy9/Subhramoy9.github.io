...
<div className="card border-light mb-3 text-violet-50" style={{maxWidth: "18rem",backgroundColor:'transparent'}}>
<div className="card-header"><button style={{backgroundColor:'transparent', color:'blue'}} onClick={submit} disabled={!tokenData} >Download APK</button></div>
<div className="card-body">
...
<div className="card border-light mb-3 text-violet-50" style={{maxWidth: "18rem",backgroundColor:'transparent'}}>
<div className="card-header"><button style={{backgroundColor:'transparent', color:'blue'}} disabled={!tokenData} onClick={submit2}>Connect to different platforms</button></div>
<div className="card-body">
